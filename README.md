...
| **macOS Ventura**: requires a custom BIOS (like 1vyrain) with CFG Lock disabled (not just the `AppleCpuPmCfgLock` Quirk) in order to re-enable ACPI CPU Power Management!
